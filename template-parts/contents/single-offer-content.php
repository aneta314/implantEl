  ...
  <div class="single-offer-content section-margin-bottom">
    ...
    if($related_posts): ?>
      <div class="related-offer-carousel">
        <h5 class="headline headline--xs"><?php pi_e('Usługi w ramach oferty', 'pi'); ?>:</h5>
    ...
    <div class="single-offer-content__faq section-margin-bottom">
      ...
      <div class="standard-format--post">
        <h6><?php pi_e('Najczęściej zadawane pytania', 'pi'); ?> </h6>
      </div>
      ...
      <div class="row">
        <?php foreach($related_metamorphosis as $metamorphosis): ?>
          <div class="col-md-6">
            ...
            get_template_part('template-parts/modules/preview-metamorphosis', null, array('post_object' => $metamorphosis)); ?>
          </div>
        <?php endforeach; ?>
      </div>
